...
export class Simulation {
     ...
     * @param {number} boids_count
     * @param {number} group_count
     * @param {HTMLElement[]} colliders
     * @returns {Simulation}
     */
    static new(canvas, boids_count, group_count, colliders) {
        const ptr0 = passArrayJsValueToWasm0(colliders, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.simulation_new(canvas, boids_count, group_count, ptr0, len0);
    ...
    update_colliders(colliders) {
        const ptr0 = passArrayJsValueToWasm0(colliders, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.simulation_update_colliders(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {number} x
     * @param {number} y
     */
    force_field(x, y) {
        wasm.simulation_force_field(this.__wbg_ptr, x, y);
    }
    disable_force_field() {
        wasm.simulation_disable_force_field(this.__wbg_ptr);
    }
    /**
     * @param {number} dt
     * @param {number} min_speed
     * @param {number} max_speed
     * @param {number} seperation_range
     * @param {number} avoid_factor
     * @param {number} alignment_range
     * @param {number} matching_factor
     * @param {number} cohesion_range
     * @param {number} centering_range
     * @param {number} fov
     * @param {number} force_field_range
     * @param {number} base_size
     * @param {number} r
     * @param {number} g
     * @param {number} b
     */
    draw(dt, min_speed, max_speed, seperation_range, avoid_factor, alignment_range, matching_factor, cohesion_range, centering_range, fov, force_field_range, base_size, r, g, b) {
        const ret = wasm.simulation_draw(this.__wbg_ptr, dt, min_speed, max_speed, seperation_range, avoid_factor, alignment_range, matching_factor, cohesion_range, centering_range, fov, force_field_range, base_size, r, g, b);
        if (ret[1]) {
     ...
     * @param {number} fov
     */
    draw_inspected(seperation_range, alignment_range, cohesion_range, fov) {
        const ret = wasm.simulation_draw_inspected(this.__wbg_ptr, seperation_range, alignment_range, cohesion_range, fov);
        if (ret[1]) {
            throw takeFromExternrefTable0(ret[0]);
        }
    }
